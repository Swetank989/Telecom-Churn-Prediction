...
pipe  = Pipeline([('Scaler', StandardScaler()),('Classifier', XGBClassifier(n_estimators=200, learning_rate=0.1, max_depth=5, random_state=0, scale_pos_weight=1, eval_metric='logloss'))])
